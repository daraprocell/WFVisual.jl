...
# NOTE: For some reason Paraview 5.6.0 runs into a glitch rendering the fluid
# domain as a volume. In order to solve that, create a calculator with the
# magnitude of the velocity and apply the volume rendering over the calculator.
